...
function renderRelatFinanceiro(r) {
  ...
  const totalInv  = invAtivos.reduce((s,i)=>s+parseFloat(i.saldo_atual != null ? i.saldo_atual : (i.valor_principal||0)),0);
  const totalDiv  = dividas.reduce((s,i)=>s+parseFloat(i.saldo_atual != null ? i.saldo_atual : (i.valor_principal||0)),0);
